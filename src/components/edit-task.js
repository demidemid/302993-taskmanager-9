...
export const getTaskEditTemplate = ({description, dueDate, repeatingDays, tags, color, isArchive, isFavorite}) => `
<article class="card card__btn--archive card--edit card--${color}
